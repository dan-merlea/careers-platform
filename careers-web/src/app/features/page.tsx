    ...
    <div className="bg-black pt-24 min-h-screen">
      <div className="max-w-[1200px] mx-auto px-6 py-24">
        ...
        <div className="space-y-32">
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            <div className="relative">
              <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 rounded-3xl p-12 border border-white/10">
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            <div className="relative order-1 lg:order-2">
              <div className="bg-gradient-to-br from-pink-900/20 to-red-900/20 rounded-3xl p-12 border border-white/10">
                <div className="space-y-4">
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            <div className="relative">
              <div className="bg-gradient-to-br from-red-900/20 to-orange-900/20 rounded-3xl p-12 border border-white/10">
                <div className="space-y-4">
        ...
        <div className="mt-32 text-center">
          <Link 
            href="/signup" 
            className="inline-flex items-center px-8 py-4 bg-white text-black rounded-xl font-semibold text-lg hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl hover:scale-105 group"
          >
            Get Started Today
