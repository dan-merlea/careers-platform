...
export default function ApiDocsPage() {
  ...
  "slug": "senior-backend-engineer-68ec13ea2a75bad5539d37b8"
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            ...
            <div className="bg-gray-100 text-gray-900 rounded-lg p-4 font-mono text-sm mb-4">
              <code>{process.env.NEXT_PUBLIC_API_URL}/job-applications/public</code>
            </div>
  ...
  "application": {
    ...
    "appliedAt": "2025-01-15T10:30:00.000Z"
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mt-8">
          ...
          <p className="text-gray-600">
            Currently, there are no rate limits on public API endpoints. However, we recommend implementing reasonable request throttling on your end to ensure optimal performance.
          </p>
        </div>
