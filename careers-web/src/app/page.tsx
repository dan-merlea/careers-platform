        ...
        <div className="relative max-w-[1200px] mx-auto px-6 py-24 sm:py-32 lg:py-40">
          <div className="text-center">
            ...
            <div className="hero-announcement inline-flex items-center space-x-2 px-4 py-2 rounded-full mb-8 bg-gray-50">
              ...
              <span className="text-sm text-gray-700">Your shortcut to career success</span>
            </div>

            {/* Main Headline */}
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight mb-6">
              <span className="block text-gray-900 mb-2">Find Your Dream</span>
            ...
            <p className="mt-6 text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              ...
              <span className="text-gray-900"> It&apos;s not about finding a job.</span> It&apos;s about building your future.
            </p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link 
                href="/signup" 
                className="group relative px-8 py-4 bg-gray-900 text-white rounded-xl font-semibold text-lg hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl hover:scale-105 w-full sm:w-auto"
              >
                Get Started
              ...
              <Link 
                href="/features" 
                className="px-8 py-4 bg-gray-100 text-gray-900 rounded-xl font-semibold text-lg hover:bg-gray-200 transition-all border border-gray-300 w-full sm:w-auto"
              >
                Learn More
              </Link>
            </div>
      ...
      <section ref={highlightRef} className="relative py-16 sm:py-24 overflow-hidden">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {/* Highlight Card 1 */}
            <div className="highlight-card bg-white rounded-3xl p-8 border border-gray-200 hover:border-purple-400 hover:shadow-xl transition-all duration-500">
            ...
            {/* Highlight Card 2 */}
            <div className="highlight-card bg-white rounded-3xl p-8 border border-gray-200 hover:border-pink-400 hover:shadow-xl transition-all duration-500">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Instant Apply</h3>
              <p className="text-gray-600 leading-relaxed text-lg">
            ...
            {/* Highlight Card 3 */}
            <div className="highlight-card bg-white rounded-3xl p-8 border border-gray-200 hover:border-blue-400 hover:shadow-xl transition-all duration-500">
            ...
            {/* Highlight Card 4 */}
            <div className="highlight-card bg-white rounded-3xl p-8 border border-gray-200 hover:border-green-400 hover:shadow-xl transition-all duration-500">
            ...
            {/* Highlight Card 5 */}
            <div className="highlight-card bg-white rounded-3xl p-8 border border-gray-200 hover:border-yellow-400 hover:shadow-xl transition-all duration-500">
            ...
            {/* Highlight Card 6 */}
            <div className="highlight-card bg-white rounded-3xl p-8 border border-gray-200 hover:border-red-400 hover:shadow-xl transition-all duration-500">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Network Building</h3>
              <p className="text-gray-600 leading-relaxed text-lg">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {categoryContent[activeCategory].map((card, index) => (
              <div
                ...
                className={`category-card group rounded-2xl overflow-hidden transition-all duration-400 hover:scale-[1.02] bg-white border border-gray-200 hover:shadow-xl ${
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <button className="w-10 h-10 rounded-xl bg-gray-100 flex items-center justify-center text-gray-900 hover:bg-gray-200 transition-all group-hover:translate-x-1">
                ...
                {/* Divider */}
                <div className="mx-6 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent"></div>
      ...
      <section className="relative py-16 sm:py-24">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {/* Feature 1 */}
            <div className="group card-hover bg-white rounded-2xl p-8 border border-gray-200 hover:border-purple-400 hover:shadow-xl">
            ...
            {/* Feature 2 */}
            <div className="group card-hover bg-white rounded-2xl p-8 border border-gray-200 hover:border-pink-400 hover:shadow-xl">
            ...
            {/* Feature 3 */}
            <div className="group card-hover bg-white rounded-2xl p-8 border border-gray-200 hover:border-red-400 hover:shadow-xl">
            ...
            {/* Feature 4 */}
            <div className="group card-hover bg-white rounded-2xl p-8 border border-gray-200 hover:border-orange-400 hover:shadow-xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Interview Scheduler</h3>
              <p className="text-gray-600 leading-relaxed">
          ...
          <div className="mt-16 text-center">
            <Link 
              href="/features" 
              className="inline-flex items-center px-8 py-4 bg-gray-100 text-gray-900 rounded-xl font-semibold hover:bg-gray-200 transition-all border border-gray-300 group"
            >
            ...
            <div className="bg-white rounded-3xl p-12 sm:p-16">
              <div className="text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link 
                    href="/signup" 
                    className="group px-8 py-4 bg-gray-900 text-white rounded-xl font-semibold text-lg hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl hover:scale-105"
                  >
                    Get Started Free
                    <span className="ml-2 inline-block transition-transform group-hover:translate-x-1">→</span>
                  </Link>
                  <Link 
                    href="/contact" 
                    className="px-8 py-4 bg-gray-100 text-gray-900 rounded-xl font-semibold text-lg hover:bg-gray-200 transition-all border border-gray-300"
                  >
                    Contact Sales
                  </Link>
                </div>
